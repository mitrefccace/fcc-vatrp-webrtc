...
module.exports = /*#__PURE__*/function (_EventEmitter) {
  ...
  _createClass(RTCSession, [{
    ...
    value: function connect(target) {
      ...
      var locationBody = Utils.cloneObject(options.locationBody)
      ...
      //Added this condition to include service urn for 911 calls
      if(target._user === '911')
        this._request.headers.To[0] = 'urn:service:sos;user=dialstring';
      ...
      this._sendInitialRequest(mediaConstraints, rtcOfferConstraints, mediaStream, locationBody);
    }
  }, {
    key: "init_incoming",
    ...
    value: function _sendInitialRequest(mediaConstraints, rtcOfferConstraints, mediaStream, locationBody) {
      var _this21 = this;
      ...
      .then(function () {
        ...
        if(locationBody.length > 0){
          _this21._request.body += locationBody
        }
